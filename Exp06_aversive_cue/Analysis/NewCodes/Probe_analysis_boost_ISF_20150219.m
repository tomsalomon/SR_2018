...
subjects = [100 101 102 103 104 105 106 107 108 109 110 111 112 113 114 115 116]; %
%exclude:
%159, 179 - due to BDM.
%182 - Ladders
%178, 186 problematic
...
for subjInd = 1:length(subjects)
    outpath = 'D:\Rotem\Matlab\Boost_Israel_New_Rotem\Output\';
    Ladder1alls = [];
    Ladder2alls = [];
    ...
    results = dir(strcat(filename, '_boostprobe','*.txt')) ;
    ...
    outpath='D:\Rotem\Matlab\Boost_Israel_New_Rotem\Output\';
    fid=fopen(strcat(outpath,results(1).name));
