...
allBidInd = vars{3};
% bidValue = vars{4};
oldStimName = allOldStimName([HV_beep HV_nobeep LV_beep LV_nobeep sanityHV_nobeep sanityLV_nobeep sanityHV_beep sanityLV_beep]);
% goNoGo = allGoNoGo([HV_beep HV_nobeep LV_beep LV_nobeep]);
isBeep = allIsBeep([HV_beep HV_nobeep LV_beep LV_nobeep   sanityHV_nobeep sanityLV_nobeep sanityHV_beep sanityLV_beep]);
bidInd = allBidInd([HV_beep HV_nobeep LV_beep LV_nobeep   sanityHV_nobeep sanityLV_nobeep sanityHV_beep sanityLV_beep]);
