...
subjects=[104,106:107,109,111,115,116,118:123,125]; % Define here your subjects' codes.
%exclude:
% 103 - did probe twice
% 114 - had poor recognition in the Old/New - consider removal ?

analysis_path=pwd; % Analysis folder location
outpath=[analysis_path(1:end-8),'Output/recall/']; % Output folder location
