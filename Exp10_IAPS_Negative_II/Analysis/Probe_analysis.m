...
% subjects=[125,201:209,211:212,214,216:229,231:234]; % Define here your subjects' codes.
subjects=[201:203,205:207,209,211:212,214,217:229,231:234]; % exluding bad subjects
%  exclusion - incomplete data:
% 210 - did not complete the experiment after code crash
% 215 - did not run this subjID - was accidentaly ran as 125 - still the
% computer stopped responding for periods of the experiment
% 230 - code crashed

%  exclusion - others:
% 205 - code crashed during training (did extra training runs)
% 204, 208, 216 - had bad training
% 213 - code crash. did training 1-3, computer crashed and then started training over
% (did 3 extra training runs)
