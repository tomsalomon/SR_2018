...
subjects=[125,201:209,211:214,216:229,231:234]; % Define here your subjects' codes.
% 210 - did not complete the experiment
% 215 - did not run this subjID - was accidentaly ran as 125
% 231 - code crashed

% consider exclusion:
% 204, 208 - stop responding at training for some periods of time
% 213 - did training 1-3, computer crashed and then started training over
% 216 - had bad training
subjects=[125,201:203,205:207,209,211:214,217:229,231:234]; % exluding weird subjects
...
for subjInd=1:length(subjects)
    ...
    filename=strcat(outpath,sprintf('*%d',subjects(subjInd)));
