...
filename = strcat(analysisOutputPath,sprintf('/%s_%d',experimentName,subjectID));
logs = dir(strcat(filename, '_training*run','*.txt')) ; % save to logs all the relevant files
