...
boost_isf_probe$PairType2[boost_isf_probe$bidIndexLeft %in% c(7, 10, 12, 13, 8, 9, 11, 14)]="HH"
boost_isf_probe$PairType2[boost_isf_probe$bidIndexLeft %in% c(47, 50, 52, 53, 48, 49, 51, 54)]="LL"
...
for (i in 1:length(boost_isf_probe$Outcome)){
	...
	if (boost_isf_probe$order[i]==1){
		...
		if (boost_isf_probe$PairType2[i]=="HH"){
		...
		else if (boost_isf_probe$PairType2[i]=="LL"){
