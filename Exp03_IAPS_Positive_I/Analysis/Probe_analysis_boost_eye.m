...
subjects= [ 187 188] %messed up probe until 148. 155 didn't understand instructions of probe
...
%    else
 ...
 %  end
   ...
   logs=dir(strcat(filename, '_eyeboostprobe','*.txt'))
    mats=dir(strcat(filename, '_eyeboostprobe','*.mat'))
    mats_train=dir(strcat(filename, '_eyeboost','*.mat'))
