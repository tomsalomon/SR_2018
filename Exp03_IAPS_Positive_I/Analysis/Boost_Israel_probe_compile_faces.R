...
boost_isf_probe$PairType2[boost_isf_probe$bidIndexLeft %in% c(7, 10, 12, 13, 8, 9, 11, 14,15, 18, 20, 21, 16, 17, 19, 22)]="HHH"
#boost_isf_probe$PairType2[boost_isf_probe$bidIndexLeft %in% c(15, 18, 20, 21, 16, 17, 19, 22)]="HHL"
#boost_isf_probe$PairType2[boost_isf_probe$bidIndexLeft %in% c(39, 42, 44, 45, 40, 41, 43, 46)]="LLH"
boost_isf_probe$PairType2[boost_isf_probe$bidIndexLeft %in% c(39, 42, 44, 45, 40, 41, 43, 46,47, 50, 52, 53, 48, 49, 51, 54)]="LLL"
...
for (i in 1:length(boost_isf_probe$Outcome)){
...
save(boost_isf_probe,file="~/Dropbox/Experiment_Israel/Codes/Boost_faces/Analysis/faces_n14.Rdata")

tapply(boost_isf_probe$Outcome2,boost_isf_probe$PairType2,mean,na.rm=T)

summary(glmer(Outcome2 ~ 1 + (1|subjectID),data=subset(boost_isf_probe,boost_isf_probe$PairType==1),na.action=na.omit,family=binomial)) 
summary(glmer(Outcome2 ~ 1 + (1|subjectID),data=subset(boost_isf_probe,boost_isf_probe$PairType==2),na.action=na.omit,family=binomial))
