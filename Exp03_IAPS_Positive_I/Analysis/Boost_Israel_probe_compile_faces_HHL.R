...
aaaa=subset(boost_isf_probe,(boost_isf_probe$PairType2=='HHL')) 
bbbb=subset(boost_isf_probe,(boost_isf_probe$PairType2=='LLH'))
...
for (i in 1:length(boost_isf_probe$PairType2)){
	...
	if (boost_isf_probe$order[i]==1){
		...
		if (boost_isf_probe$PairType2[i]=="HHL"){
...
save(boost_isf_probe,file="~/Dropbox/Experiment_Israel/Codes/Boost_faces/Analysis/faces_n20.Rdata")
