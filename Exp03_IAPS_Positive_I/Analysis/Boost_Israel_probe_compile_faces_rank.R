...
summary(glmer(Outcome2 ~ PairType + (1|subjectID),data=subset(boost_isf_probe,boost_isf_probe$PairType2 %in% c('HHH','LLL')),na.action=na.omit,family=binomial)) #effect of Go choice for HH vs LL
