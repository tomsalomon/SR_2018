...
if test_comp == 1
    ...
    if numRun == 1
        if  block == 1 || block == 3 % If this is the first run of the first block, show instructions
%             Screen('TextSize',w, 60);
%             if sessionNum == 1
%                 CenterText(w,'PART 5:', white,0,-500);
%             else
...
if test_comp == 1 % An fMRI experiment. Edit so that it would be good for the fmri experiment
    ...
    elseif mod(block,2) == 1 && sessionNum > 1 && numRun == numRunsPerBlock
        ...
        %run
        CenterText(w,sprintf('Part 5 is done') ,white,0,-270);
        CenterText(w,sprintf('Questions?') ,white,0,-170);
        Screen('Flip',w);
        WaitSecs(3);
        Screen('CloseAll');
    ...
    elseif mod(block,2) == 0 && sessionNum == 1 && numRun == numRunsPerBlock
        ...
        CenterText(w,sprintf('Please read the Part 5 instructions and call the experimenter.') ,white,0,-270);
        CenterText(w,sprintf('Press any key to continue.') ,white,0,-170);
        Screen('Flip',w);
    ...
    elseif mod(block,2) == 0 && sessionNum > 1 && numRun == numRunsPerBlock
        ...
        CenterText(w,sprintf('Please read the Part 2 instructions and call the experimenter.') ,white,0,-270);
        CenterText(w,sprintf('Press any key to continue.') ,white,0,-170);
        Screen('Flip',w);
