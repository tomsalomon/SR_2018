...
% function [] = training_Israel(subjectID,order,mainPath,test_comp,runInd,total_num_runs_training_trainingLadder1IN,Ladder2IN)
...
% test_comp = 4;
% order = 1;
% mainPath = '/Users/schonberglabimac1/Documents/BMI_BS_40'; % mac
% mainPath = 'D:\Rotem\Dropbox\Rotem\BMI_bs_40_052015\BMI_BS_40'; % my PC
% runInd = 1;
...
for runNum = runInd:total_num_runs_training %this for loop allows all runs to be completed
    ...
    fid1 = fopen([outputPath '/' subjectID 'training40_run_' sprintf('%02d',runNum) '_' timestamp '.txt'], 'a');
    fprintf(fid1,'subjectID\torder\trunNum\titemName\tonsetTime\tshuff_trialType\tRT\trespInTime\tCueTime\tresponse\tfixationTime\tladder1\tladder2\tbidIndex\tBDMtrialIndex\tbidValue\n'); %write the header line
...
CenterText(w,'Part 3 will begin soon', white, 0, -180);
CenterText(w,'Please read the Part 3 instructions in front of you,',white, 0,-120);
CenterText(w,'Please call the experimenter.',white, 0,-60);
Screen('Flip',w);
