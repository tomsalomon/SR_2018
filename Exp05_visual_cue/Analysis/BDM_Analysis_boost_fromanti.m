...
if test_comp==0
    outpath='~/Documents/AntiBoost/Output/';
elseif test_comp==2
    outpath='~/Dropbox/Documents/Trained_Inhibition/AntiBoost/Output/';
end
...
BDM_1_NonEx_O1(O1_count,1)=mean(sortedM1([16 19 20 23    ],1)); %stop High ?
BDM_1_NonEx_O1(O1_count,2)=mean(sortedM1([38 41 42 45   ],1)); % go High
BDM_1_NonEx_O1(O1_count,3)=mean(sortedM1([  17 18 21 22] ,1)); % stop Low
BDM_1_NonEx_O1(O1_count,4)=mean(sortedM1([   39 40 43 44],1)); % go Low
BDM_1_NonEx_O1(O1_count,5)=subjects(subjInd); % go Low
BDM_1_NonEx_O1(O1_count,6)=order; % go Low
...
BDM_2_NonEx_O1(O1_count,1)=mean(sortedM2(sortedM1([16 19 20 23],2),2)); %stop High ?
BDM_2_NonEx_O1(O1_count,2)=mean(sortedM2(sortedM1([38 41 42 45],2),2)); % go High
BDM_2_NonEx_O1(O1_count,3)=mean(sortedM2(sortedM1([17 18 21 22],2),2)); % stop Low
BDM_2_NonEx_O1(O1_count,4)=mean(sortedM2(sortedM1([ 39 40 43 44],2),2)); % go Low
BDM_2_NonEx_O1(O1_count,5)=subjects(subjInd); % go Low
BDM_2_NonEx_O1(O1_count,6)=order; % go Low
...
BDM_1_NonEx_O2(O2_count,1)=mean(sortedM1([17 18 21 22   ],1)); %stop High ?
BDM_1_NonEx_O2(O2_count,2)=mean(sortedM1([39 40 43 44  ],1)); % go High
BDM_1_NonEx_O2(O2_count,3)=mean(sortedM1([  16 19 20 23] ,1)); % stop Low
BDM_1_NonEx_O2(O2_count,4)=mean(sortedM1([   38 41 42 45],1)); % go Low
BDM_1_NonEx_O2(O2_count,5)=subjects(subjInd); % go Low
BDM_1_NonEx_O2(O2_count,6)=order; % go Low
...
BDM_2_NonEx_O2(O2_count,1)=mean(sortedM2(sortedM1([17 18 21 22 ],2),2)); %stop High ?
BDM_2_NonEx_O2(O2_count,2)=mean(sortedM2(sortedM1([39 40 43 44],2),2)); % go High
BDM_2_NonEx_O2(O2_count,3)=mean(sortedM2(sortedM1([16 19 20 23 ],2),2)); % stop Low
BDM_2_NonEx_O2(O2_count,4)=mean(sortedM2(sortedM1([38 41 42 45],2),2)); % go Low
BDM_2_NonEx_O2(O2_count,5)=subjects(subjInd); % go Low
BDM_2_NonEx_O2(O2_count,6)=order; % go Low
...
BDM_Ex_all=[BDM_1_Ex_O1 BDM_2_Ex_O1; BDM_1_Ex_O2 BDM_2_Ex_O2 ] 
BDM_NonEx_all=[BDM_1_NonEx_O1 BDM_2_NonEx_O1; BDM_1_NonEx_O2 BDM_2_NonEx_O2 ] 


[h,p]=ttest(BDM_Ex_all(:,1)-BDM_Ex_all(:,2),BDM_Ex_all(:,7)-BDM_Ex_all(:,8)) 
[h,p]=ttest(BDM_Ex_all(:,3)-BDM_Ex_all(:,4),BDM_Ex_all(:,9)-BDM_Ex_all(:,10)) 
...
subtractions_NonEx=[BDM_NonEx_all(:,2)-BDM_NonEx_all(:,1) BDM_NonEx_all(:,4)-BDM_NonEx_all(:,3) BDM_NonEx_all(:,8)-BDM_NonEx_all(:,7) BDM_NonEx_all(:,10)-BDM_NonEx_all(:,9) BDM_NonEx_all(:,5)]
[Y,I]=sort(subtractions_NonEx(:,5))
sorted_subtract_BDMNonEx=subtractions_NonEx(I,:)

subtractions_BDMEx=[BDM_Ex_all(:,2)-BDM_Ex_all(:,1) BDM_Ex_all(:,4)-BDM_Ex_all(:,3) BDM_Ex_all(:,8)-BDM_Ex_all(:,7) BDM_Ex_all(:,10)-BDM_Ex_all(:,9) BDM_Ex_all(:,5)]
[Y,I]=sort(subtractions_BDMEx(:,5))
sorted_subtract_BDMEx=subtractions_BDMEx(I,:)


% 
% sorted_subtract_BDMNonEx_sub=sorted_subtract_BDMNonEx(:,3)-sorted_subtract_BDMNonEx(:,1)
% [r,p]=corr(sorted_subtract_BDMNonEx_sub,highs_stop)
% [r,p]=corr(sorted_subtract_BDMNonEx_sub,highs_go)
% sorted_subtract_BDMNonEx_sub_stop=sorted_subtract_BDMNonEx(:,4)-sorted_subtract_BDMNonEx(:,2)
% [r,p]=corr(sorted_subtract_BDMNonEx_sub_stop,highs_stop)
% plot(sorted_subtract_BDMNonEx_sub_stop,highs_stop,'*')
% [r,p]=corr(sorted_subtract_BDMNonEx_sub_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1),highs_stopfind(sorted_subtract_BDMNonEx_sub_stop>-1))
% [r,p]=corr(sorted_subtract_BDMNonEx_sub_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1),highs_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1))
% plot(sorted_subtract_BDMNonEx_sub_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1)),highs_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1)),'*')
% [r,p]=corr(sorted_subtract_BDMNonEx_sub_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1&highs_stop>10)),highs_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1&highs_stop>10)))
% plot(sorted_subtract_BDMNonEx_sub_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1&highs_stop>10)),highs_stop(find(sorted_subtract_BDMNonEx_sub_stop>-1&highs_stop>10)),'*')
