...
% ~~~~~~ Script for analyzing probe results, modified ~~~~~~
% ~~~~~~~~~~~~~~~ Tom Salomon, May 2016  ~~~~~~~~~~~~~~
%
...
subjects=[102:104,106,108,110:111,113,115:116,118:120,123:124,126]; % Define here your subjects' codes.
%exclude:
...
outpath=['./../Output/recall/']; % Output folder location
...
% Correlate with followup recognition
Recognition_results=recognition_analysis(subjects,outpath);
% Correlate with original recognition
% Recognition_results=recognition_analysis(subjects,[outpath,'../']);
