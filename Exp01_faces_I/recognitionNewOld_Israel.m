...
allBidInd = vars{3};
% bidValue = vars{4};
oldStimName = allOldStimName([HV_beep HV_nobeep LV_beep LV_nobeep sanityHV_beep sanityLV_beep sanityHV_nobeep sanityLV_nobeep]);
% goNoGo = allGoNoGo([HV_beep HV_nobeep LV_beep LV_nobeep]);
isBeep = allIsBeep([HV_beep HV_nobeep LV_beep LV_nobeep sanityHV_beep sanityLV_beep sanityHV_nobeep sanityLV_nobeep]);
bidInd = allBidInd([HV_beep HV_nobeep LV_beep LV_nobeep sanityHV_beep sanityLV_beep sanityHV_nobeep sanityLV_nobeep]);
...
newStimName = dir([mainPath '\stim\recognitionNew\*.TIF']); % Read new stimuli
...
% ixlswrite(xlsfilename,timestamp_cell,xlsheet,'B3');
