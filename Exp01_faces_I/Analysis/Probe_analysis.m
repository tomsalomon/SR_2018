...
%subjects=[101:116,119:120,125:134]; 
subjects=[101:104,106,108:110,112:114,119:120,125:126,130,132:134]% Define here your subjects' codes.
%exclude:
...
% 105, 107, 111, 115, 116, 127, 128, 129, 131 - training
...
% end
chose_go_total=(probe_for_recognition(:,3).*probe_for_recognition(:,7)+probe_for_recognition(:,4).*probe_for_recognition(:,8))./(probe_for_recognition(:,3)+probe_for_recognition(:,4));

recognition_summery=[mean(Recognition_results(:,2)),mean(Recognition_results(:,3)),...
    corr(chose_go_total,Recognition_results(:,3)),r_values(1),r_values(2)]
