...
% ----------------------------------
% For creaing onsetlists for the probe, we used jitter mean 3, min 1, max 12, interval 1; numTrials 68 (for sum of 136 comparisons), requiredLength 336 (2*67+1 for pair number) (and them when adding 2 to the diff matrix we get mean 5, min 3, max 14, interval 1),
% lengthOnsetlist should match the number of comparisons in the probe / 2 (for example, 68)
