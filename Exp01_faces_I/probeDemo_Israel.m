...
fid1=fopen([outputPath '/' subjectID sprintf('_faces_probe_demo_') timestamp '.txt'], 'a');
...
outfile=strcat(outputPath, sprintf('/%s_faces_probe_demo_%s.mat', subjectID, timestamp));
